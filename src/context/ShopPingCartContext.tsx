...
type ShoppingCartContext = {
  ...
  checkOutOpen: () => void;
  checkOutClose: () => void;
  handelToggleCart:(isOpen:boolean)=>void
  setOpenToggleCart :any
};
...
export function ShoppingCartProvider({ children }: ShoppingCrtProviderShop) {
  ...
  const [openToggleCart, setOpenToggleCart] = useState(false);
  ...
  const handelToggleCart =(isOpen:boolean)=>{
    setOpenToggleCart(isOpen)
  }
  ...
  return (
    ...
    >
      ...
      <ShopingTabCart openToggleCart={openToggleCart} />
    </ShoppingCartContext.Provider>
  );
}
